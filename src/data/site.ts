...
export const UI = {
  ...
  prevPost: { fr: 'Publication précédente', de: 'Vorheriger Beitrag' },
  nextPost: { fr: 'Publication suivante', de: 'Nächster Beitrag' },
  prevShort: { fr: 'Précédente', de: 'Vorheriger' },
  nextShort: { fr: 'Suivante', de: 'Nächster' },
  photoN: { fr: 'Photo', de: 'Foto' },
  ofN: { fr: 'sur', de: 'von' },
  instagramHandle: { fr: '@scouts.europe.suisse', de: '@scouts.europe.suisse' },
