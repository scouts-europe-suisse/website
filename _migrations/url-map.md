# Carte des adresses — ancien site vers nouveau

Établie le 2026-09-10, depuis l'export de la base du WordPress.

**À quoi ça sert.** Une adresse qui disparaît sans redirection, c'est un lien mort : dans un
dépliant, sur la page d'un groupe local, dans les favoris d'un parent, et surtout dans
l'index de Google, où la page perd sa place. Chaque ligne ci-dessous doit donc mener quelque
part le jour de la bascule.
...
|---|---|---|
| `/de/carrick-2/` | `/de/carrick/` | page |
| `/de/category/actualites/` | `/de/aktuelles/` | catégorie WordPress |
| `/de/die-beweguni/` | `/de/die-bewegung/` | page |
| `/de/die-beweguni/ausbildung-der-leiter/` | `/de/die-bewegung/ausbildung-der-leiter/` | page |
| `/de/die-beweguni/betreuung/` | `/de/die-bewegung/betreuung/` | page |
| `/de/die-beweguni/unsere-grundungstexte/` | `/de/die-bewegung/` | page vide, redirigée vers la page utile |
...
| `/fr/pelerinage-national-2023/` | `/fr/actualites/pelerinage-national-2023/` | actualité |
| `/fr/pelerinage-national-des-scouts-deurope-a-sion/` | `/fr/actualites/pelerinage-national-des-scouts-deurope-a-sion/` | actualité |
| `/fr/qui-sommes-nous/` | `/fr/actualites/` | actualité vide sur l’ancien site |
| `/fr/rencontre-nationale-2013/` | `/fr/actualites/rencontre-nationale-2013/` | actualité |
| `/fr/rencontre-nationale-louvetisme-2015/` | `/fr/actualites/rencontre-nationale-louvetisme-2015/` | actualité |
| `/fr/route-vers-fatima-dons/` | `/fr/actualites/route-vers-fatima-dons/` | actualité |
| `/fr/routiers-et-guides-ainees/` | `/fr/branche-rouge/` | page vide, redirigée vers la page utile |
| `/fr/scouteuroptour-2/` | `/fr/actualites/scouteuroptour-2/` | actualité |
| `/fr/scouteuroptour/` | `/fr/actualites/scouteuroptour/` | actualité |
| `/fr/scouteuroptour2/` | `/fr/actualites/scouteuroptour2/` | actualité |
| `/fr/we-koudou-eclaireuses-octobre-2022/` | `/fr/actualites/we-koudou-eclaireuses-octobre-2022/` | actualité |
...
- **Les fichiers de la médiathèque** (`/SiteSES/wp-content/uploads/…`). Ils ne sont pas
  redirigés un par un : ceux qui servent au nouveau site y sont recopiés sous `/images/`,
  les autres disparaissent avec l'ancien site. Voir
  [`images/README.md`](images/README.md).
- **Les pages de l'ancien « site des aînés »**, qui vivait sur un autre WordPress et n'a
  jamais fait partie du site public.

## À vérifier avant la bascule

1. Passer un outil de crawl sur l'ancien site et comparer la liste obtenue à cette table :
   il reste toujours des adresses que personne n'avait en tête.
2. Récupérer la liste des pages indexées dans la Search Console de Google, si le mouvement
   y a accès : c'est la seule source qui dise ce que les moteurs connaissent vraiment.
3. Vérifier que les redirections fonctionnent une fois le site en ligne, avant de couper
   l'ancien.
